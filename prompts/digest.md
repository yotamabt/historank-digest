...
Fetch at least 8 events. Get full model data for every event (all four models,
scores and explanations). Use web search and web fetch to gather historical
context, recent scholarship, and any detail that sharpens the story.
